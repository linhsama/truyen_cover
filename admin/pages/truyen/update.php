...
<div class="main-update">
    ...
    <form class="form-group" action="pages/truyen/action.php?req=update" method="post" enctype="multipart/form-data"
        id="formTruyen">
        <input type="hidden" class="form-control" id="truyen_id" name="truyen_id" required
            value="<?= $truyen__Get_By_Id->truyen_id ?>" readonly>
        <input type="hidden" class="form-control" id="truyen_anh_bia_cu" name="truyen_anh_bia_cu" required
            value="<?= $truyen__Get_By_Id->truyen_anh_bia ?>" readonly>
        <input type="hidden" class="form-control" id="truyen_luot_xem" name="truyen_luot_xem" required readonly
            value="<?= $truyen__Get_By_Id->truyen_luot_xem ?>">
        <div class="col">
            ...
            <input type="text" class="form-control" id="truyen_ten" name="truyen_ten" required
                value="<?= $truyen__Get_By_Id->truyen_ten ?>">
        </div>
        <div class="col">
            ...
            <input type="text" class="form-control" id="truyen_tac_gia" name="truyen_tac_gia" required
                value="<?= $truyen__Get_By_Id->truyen_tac_gia ?>">
        </div>
        <div class="col">
            ...
            <div id="truyen_anh_bia_preview"><img src="<?= $truyen__Get_By_Id->truyen_anh_bia ?>"
                    alt="<?= $truyen__Get_By_Id->truyen_ten ?>" class="img-fluid" width="200"></div>
        </div>
        <div class="col">
            <label for="truyen_trang_thai" class="form-label">Trạng thái</label>
            <select class="form-select " aria-label=". truyen_trang_thai" id="truyen_trang_thai"
        ...
        <div class="col">
            ...
            <textarea class="form-control" id="truyen_mo_ta" name="truyen_mo_ta"
                required><?= $truyen__Get_By_Id->truyen_mo_ta ?></textarea>
        </div>
        <div class="col">
            <label for="truyen_tinh_trang" class="form-label">Tình trạng</label>
            <select class="form-select " aria-label=". truyen_tinh_trang" id="truyen_tinh_trang"
        ...
        <div class="col">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="the_loai_id<?= $item->the_loai_id ?>"
                    value="<?= $item->the_loai_id ?>" name="the_loai_id[]" <?= $isChecked ? 'checked' : '' ?>>
                <label class="form-check-label"
                    for="the_loai_id<?= $item->the_loai_id ?>"><?= $item->the_loai_ten ?></label>
            </div>
            <?php endforeach; ?>
        </div>
        ...
        <div class="col">
            ...
            <input type="text" class="form-control" id="truyen_ngay_dang" name="truyen_ngay_dang" required readonly
                value="<?= $truyen__Get_By_Id->truyen_ngay_dang ?>">
        </div>
        <br />
