                    ...
                    <table id="table_js" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="<?= $item->chapter_noi_dung_image ?>"
...
function update_obj(chapter_noi_dung_id) {
    $.post("pages/chapter-noi-dung/update.php", {
...
function add_obj() {
    $.post("pages/chapter-noi-dung/add.php", {}, function(data, status) {
        $(".main-form").html(data);
    });
};
...
function delete_obj(chapter_noi_dung_id) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            location.href = "pages/chapter-noi-dung/action.php?req=delete&chapter_noi_dung_id=" +
                chapter_noi_dung_id;
        } else if (
