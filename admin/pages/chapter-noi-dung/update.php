...
<div class="main-update">
    ...
    <form class="form-group" action="pages/chapter-noi-dung/action.php?req=update" method="post" enctype="multipart/form-data">
        ...
        <div class="col">
            ...
            <div id="chapter_noi_dung_image_preview"><img src="<?= $chapterNoiDung__Get_By_Id->chapter_noi_dung_image ?>" alt="<?= $chapterNoiDung__Get_By_Id->chapter_id ?>" class="img-fluid" width="200"></div>
        </div>
        <div class="col">
