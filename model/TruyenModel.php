...
class TruyenModel extends Database
{
    ...
    public function Truyen__Add($truyen_ten, $truyen_tac_gia, $truyen_mo_ta, $truyen_anh_bia, $truyen_tinh_trang, $truyen_luot_xem, $truyen_luot_thich, $truyen_luot_theo_doi, $truyen_ngay_dang, $truyen_trang_thai)
    {
        $obj = $this->connect->prepare("INSERT INTO truyen(truyen_ten, truyen_tac_gia, truyen_mo_ta, truyen_anh_bia, truyen_tinh_trang, truyen_luot_xem, truyen_luot_thich, truyen_luot_theo_doi, truyen_ngay_dang, truyen_trang_thai) VALUES (?,?,?,?,?,?,?,?,?,?)");
        $obj->execute(array($truyen_ten, $truyen_tac_gia, $truyen_mo_ta, $truyen_anh_bia, $truyen_tinh_trang, $truyen_luot_xem, $truyen_luot_thich, $truyen_luot_theo_doi, $truyen_ngay_dang, $truyen_trang_thai));
        return $this->connect->lastInsertId();
    }

    public function Truyen__Update($truyen_id, $truyen_ten, $truyen_tac_gia, $truyen_mo_ta, $truyen_anh_bia, $truyen_tinh_trang, $truyen_trang_thai)
    {
        $obj = $this->connect->prepare("UPDATE truyen SET truyen_ten=?, truyen_tac_gia=?, truyen_mo_ta=?, truyen_anh_bia=?, truyen_tinh_trang=?, truyen_trang_thai=? WHERE truyen.truyen_trang_thai = 1 AND truyen_id=?");
        $obj->execute(array($truyen_ten, $truyen_tac_gia, $truyen_mo_ta, $truyen_anh_bia, $truyen_tinh_trang, $truyen_trang_thai, $truyen_id));
        return $obj->rowCount();
    }
    ...
    public function Truyen__Get_The_Loai_Paged($page_number, $the_loai_id)
    {
        ...
        $obj = $this->connect->prepare(
            ...
            FROM truyen
            JOIN truyen_the_loai ON truyen.truyen_id = truyen_the_loai.truyen_id
