...
<main class="main">
    ...
    <div class="main-container">
        ...
        <div class="main-item-container">
            ...
            <a
                href="index.php?pages=truyen-xem&truyen_id=<?= $chapter__Get_Latest_By_Truyen_Id->truyen_id ?>&chapter_id=<?= $chapter__Get_Latest_By_Truyen_Id->chapter_id ?>&chapter_so=<?= $chapter__Get_Latest_By_Truyen_Id->chapter_so ?>">
            ...
            <div class="main-item-container__left">
                ...
                <div class="manga-container__left">
                    <a href="index.php?pages=truyen-chi-tiet&truyen_id=<?= $item->truyen_id ?>">
                        <div class="manga-thumbnail">
                            <img src="<?= $item->truyen_anh_bia ?>">
                            <span class="manga-note background-2"><?= $cm->getTimeAgo($item->truyen_ngay_dang); ?> <i
                                    class="bx bxs-star"></i></span>
                        </div>
                    </a>
                    <div class="manga-chapter-container__left">
                        ...
                        <div class="chapter-container__left">
                            ...
                            <span class="hr"></span>
                            <a
                                href="index.php?pages=truyen-xem&truyen_id=<?= $item_chap_moi->truyen_id ?>&chapter_id=<?= $item_chap_moi->chapter_id ?>&chapter_so=<?= $item_chap_moi->chapter_so ?>">
